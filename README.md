...
A responsive and user-friendly *Weather Application* that allows users to search for real-time weather information for cities around the world. The app fetches live weather data from a public weather API and displays current conditions in a clean and intuitive interface.
